...
process(bcode) begin
	...
	case bcode is
		...
		when "11110010" => addr <= "10101011101";	--	055d	jopsys_dcall
		when "11110011" => addr <= "10101011110";	--	055e	jopsys_cdresult
		when "11010001" => addr <= "10101011111";	--	055f	jopsys_rd
		when "11010011" => addr <= "10101011111";	--	055f	jopsys_rdmem
		when "11010010" => addr <= "10101100011";	--	0563	jopsys_wr
		when "11010100" => addr <= "10101100011";	--	0563	jopsys_wrmem
		when "11010101" => addr <= "10101101000";	--	0568	jopsys_rdint
		when "11010110" => addr <= "10101101011";	--	056b	jopsys_wrint
		when "11010111" => addr <= "10101101110";	--	056e	jopsys_getsp
		when "11011000" => addr <= "10101110001";	--	0571	jopsys_setsp
		when "11011001" => addr <= "10101110101";	--	0575	jopsys_getvp
		when "11011010" => addr <= "10101110110";	--	0576	jopsys_setvp
		when "11011011" => addr <= "10101111000";	--	0578	jopsys_int2ext
		when "11011100" => addr <= "10110010011";	--	0593	jopsys_ext2int
		when "11101000" => addr <= "10110101111";	--	05af	jopsys_memcpy
		when "11011101" => addr <= "10110110100";	--	05b4	jopsys_nop
		when "11011111" => addr <= "10110110101";	--	05b5	jopsys_cond_move
		when "11001100" => addr <= "10110111011";	--	05bb	jopsys_inval
